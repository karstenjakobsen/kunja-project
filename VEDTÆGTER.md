...
2.2. Selskabet kan drive bofællesskab og erhverve ejendommen Kirkeby Sand 19.  
2.3. Selskabet kan på sigt byggemodne byggegrunde.  
2.4. Selskabet kan etablere en platform for iværksætteri og hjemmeskoling.  
2.5. Selskabet kan generere indtægter (f.eks. via glamping, events/retreats, konsulentydelser etc.) for at understøtte fællesskabet og opbygge selskabets egenkapital.  
2.6. Selskabet følger de mål, der fremgår af den interne vision (jf. Bilag 1).
...
5.3. Selskabets generalforsamlinger afholdes som udgangspunkt på selskabets hjemsted eller et andet sted, hvis anpartshaverne er enige herom.  
5.4. Den ordinære generalforsamling skal afholdes årligt i så god tid, at den godkendte årsrapport kan indsendes til Erhvervsstyrelsen inden den lovpligtige frist.  
5.5. Ekstraordinær generalforsamling skal afholdes, når Selskabets direktør eller eventuelt generalforsamlingsvalgte revisor har forlangt det.  
5.6. Generalforsamlinger indkaldes af direktøren (eller den, styregruppen bemyndiger) senest 2 uger og tidligst 4 uger før.  
5.7. En anpartshaver har ret til at få et bestemt emne optaget på dagsordenen for den ordinære generalforsamling. Forslaget fremsættes over for direktøren i så god tid som muligt.  
5.8. Generalforsamlinger er ikke offentlige, medmindre der gives særlig tilladelse.  
5.9. Senest 2 uger før generalforsamlingen skal dagsorden og de fuldstændige forslag gøres tilgængelige for anpartshaverne (ved ordinær generalforsamling ligeledes årsrapporten).  
5.10. Dagsorden for den ordinære generalforsamling skal mindst indeholde:  
   1. Valg af dirigent  
   2. Direktørens (eller ledelsens) beretning om Selskabets virksomhed i det forløbne år  
   3. Godkendelse af årsrapport  
   4. Anvendelse af overskud eller dækning af underskud  
   5. Valg af eventuel revisor (hvis relevant)  
   6. Valg af eventuelle nye bestyrelsesmedlemmer, hvis Selskabet beslutter at have en bestyrelse  
   7. Eventuelle forslag fra ledelse eller anpartshavere

## 6. Generalforsamlingens stemme- og repræsentationsret
6.1. Hver anpartshaver har 1 stemme, uanset antallet af anparter.  
6.2. En anpartshaver kan møde ved fuldmægtig eller med en rådgiver. Fuldmagt skal være skriftlig og dateret.  
6.3. En anpartshaver kan brevstemme. Brevstemmen skal være modtaget af Selskabet senest kl. 10.00 dagen før afholdelse.  

## 7. Generalforsamlingens dirigent, beslutninger og protokol
7.1. Generalforsamlingen vælger en dirigent, der leder mødet.  
7.2. Beslutninger træffes ved simpelt flertal, medmindre andet følger af selskabsloven eller disse vedtægter (f.eks. 2/3-flertal ved vedtægtsændringer).  
7.3. Der føres en protokol, som underskrives af dirigenten. Den skal være tilgængelig for anpartshaverne senest 2 uger efter mødet.
...
8.4. **Styregruppen** er Selskabets øverste kreds og består af alle anpartshavere. Styregruppen varetager alle Selskabets overordnede forhold, fx:  
   ...
   - Godkendelse af nye anpartshavere  
   - Eventuel fratagelse af anpartsrettigheder  
8.5. Referater af møder i styregruppen eller hos direktøren skal indføres i en protokol, der godkendes af de tilstedeværende anpartshavere.  
8.6. Selskabet har som udgangspunkt ikke en bestyrelse eller et tilsynsråd. Skulle en sådan senere ønskes, kræver det vedtægtsændring.

## 9. Elektronisk kommunikation
9.1. Selskabet kan anvende elektronisk post (e-mail) i kommunikationen med anpartshaverne, herunder til indkaldelse til generalforsamling, fremsendelse af dagsorden, årsrapport mv. Anpartshaverne har pligt til at oplyse Selskabet om en gyldig e-mailadresse.  

## 10. Tegningsregel
10.1. Selskabet tegnes af den registrerede direktør.  
...
12.1. En anpartshaver, der afdrager på sit indskud, men ikke overholder de aftalte afdrag, kan miste stemmeret eller indsigelsesret, indtil betaling er bragt i overensstemmelse med planen.  
12.2. Manglende betaling udgør alene ikke grundlag for eksklusion.  
12.3. Eksklusion kan kun ske med 100 % samtykke blandt de øvrige anpartshavere. Den anpartshaver, hvis eksklusion behandles, deltager ikke i selve eksklusionsafgørelsen.  
12.4. Eventuelle økonomiske mellemværender afklares efter reglerne i disse vedtægter, herunder om indskud først kan udbetales efter 31. december 2030.

## 13. Bilag til vedtægterne
- **Bilag 1: Intern vision**  
- **Bilag 2: Ejendommen Kirkeby Sand 19**  
- **Bilag 3: Spireprocess**  
...
### 13.1. Ændring af bilag  
Ændring af bilag 1-5 sker efter de samme principper, som gælder for ændring af nærværende vedtægter, medmindre andet fremgår.
